...
%UNSAMPH     Un- sample and hold two-sided polynomial
%
% Two-sided polynomial G is supposed to be a result of
% sampling and holding of continuous time polynomial F
% with period T and phase TAU. The command
%     F = UNSAMP(G,T,TAU)
