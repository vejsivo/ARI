function B = resamph(A,k,h,l)
%RESAMPH     Resample and hold two-sided polynomial
%
% For two-sided polynomial F, the command
%  G = RESAMPH(F,K,H,L)  returns two-sided polynomial G,
% the result of holding with interval L and resampling
% with period K and phase L.
%
% For more details, see FRAC/RESAMPH, POL/RESAMPH.
...
BB = 0;
eval('BB = resamph(Ap,k,h,l);','error(peel(lasterr));');
