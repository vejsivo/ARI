function B = resamph1(A,k,h,l)
%RESAMPH1     Resample and first order hold two-sided polynomial
%
% For two-sided polynomial F, the command
%  G = RESAMPH1(F,K,H,L)  returns two-sided polynomial G,
% the result of first order holding with interval L and
% resampling with period K and phase L.
%
% For more details, see FRAC/RESAMPH1, POL/RESAMPH1.
...
BB = 0;
eval('BB = resamph1(Ap,k,h,l);','error(peel(lasterr));');
