function R = ldivide(Q,P,var)
%LDIVIDE(.\)   Element-wise left divide two-sided polynomials
%
% The command  R = LDIVIDE(Q,P)  or  R = Q.\P  left divides tsp
...
% argument VAR, e.g.  R = LDIVIDE(Q,P,'z^-1') .
%
% See also TSP/RDIVIDE, TSP/MLDIVIDE, TSP/MRDIVIDE.
