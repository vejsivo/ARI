...
%DEFRACT     Defract scalar-den fraction 
%             (remove denominator if possible)
%
% The command  Q = DEFRACT(F)  defracts scalar-den fraction F,
% i.e. removes the denominator if it is eqaul to 1.
%
% The command  [Q,C] = DEFRACT(F)
% returns also the resulting class in C.
%
% See also SDF/COPRIME, SDF/REDUCE, FRAC/POL.
