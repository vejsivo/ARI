...
%RESHAPE        Change size of scalar-den fraction
%
% For scalar-den fraction P, the command Q = RESHAPE(P,M,N)
% returns a M-by-N scalar-den fraction whose elements are
% taken columnwise from P. An error results if P has
% not M*N elements.
%
...
eval('P = sdf(P);','error(peel(lasterr));');
