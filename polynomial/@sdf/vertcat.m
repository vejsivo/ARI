...
%VERTCAT    Vertical concatenate scalar-den fractions
%
% The command
%    R = [P;Q]
% returns the vertical concatenation of scalar-den fractions P and Q.
% Both of them must have the same number of columns. Any number of
