...
%                  scalar-den fraction
%
% Discrete time scalar-den fraction G is supposed to
...
% formally. Note, however, that the meaning of the
...
% allowed: it must be equal to  K*z*inv(z-1)  or
%  K*q*inv(q-1),  K*inv(1-z^-1),  K*inv(1-d) . The result H
% is equal to G.
%
...
%    'ss' - state space
%
% See also SDF/SAMP, FRAC/UNSAMP, SDF/RESAMP.
