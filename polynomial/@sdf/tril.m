...
%TRIL    Lower triangular part of scalar-den fraction
%
...
Al = 0;
eval('Al = sdf(tril(A.frac.num,k),A.frac.den);', ...
   'error(peel(lasterr));');

if strcmp(A.frac.r,'red'), props(Al,'red');
end;
if strcmp(A.frac.p,'prop'), props(Al,'prop',A.frac.tp);
end;
