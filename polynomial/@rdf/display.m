function display(F)
%DISPLAY   Display right-denominator fraction
%
% Syntax
%    DISPLAY(F)
% The display format is set by macro PFORMAT.

%       Author(s):  S. Pejchova  13-12-99
%       Copyright (c) 1999 by Polyx, Ltd.
%       $Revision: 3.0 $  $Date: 16-Feb-2000 10:51:27   $
...
str_L=pdisp(F.frac.num);
str_R=pdisp(F.frac.den);
...
if row,
   ...
   S_out=['  Right-denominator fraction (numerator/denominator)',str_vr,': ',int2str(s1),'-by-',int2str(s2)];
