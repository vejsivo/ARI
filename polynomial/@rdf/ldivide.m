...
%LDIVIDE(.\)    Element-wise left divide right-den fractions
%           R = Q.\P   or   R = LDIVIDE(Q,P)
%
% For right-den fractions  Q,P  the command returns right-den fraction R
...
%
% See also RDF/RDIVIDE, FRAC/MRDIVIDE, FRAC/MLDIVIDE.
...
eval('Q = mdf(Q); P = mdf(P);','error(peel(lasterr));');
