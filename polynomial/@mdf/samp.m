...
%SAMP   Sample continuous time matrix-den fraction
%
% Let F be a matrix-denominator fraction in variable 's' or 'p'.
% The command  G = SAMP(F,T,TAU) where scalars T,TAU are
% sampling period, T>=0  and sampling phase,  TAU >=0 ,
% returns proper matrix-denominator fraction G in variable
% 'z','q','z^-1' or 'd', whose Laurent series equals to the
...
%
% See also MDF/LAURENT, FRAC/LAPLACE, MDF/RESAMP.
