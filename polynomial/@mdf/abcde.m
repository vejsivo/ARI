...
%ABCDE   Descriptor state space realization of matrix-den fraction
%
% For matrix-denominator fraction F, the command
%    [A,B,C,D,E] = ABCDE(F)
% returns the descriptor state space realization A,B,C,D, that is
%    F(x) = C*(xE-A)^-1*B + D
