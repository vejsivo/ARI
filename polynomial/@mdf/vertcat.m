...
%VERTCAT    Vertical concatenate matrix-den fractions
%
% The command
%    R = [P;Q]
% returns the vertical concatenation of matrix-den fractions
% P and Q. Both of them must have the same number of columns. Any number
% of matrices may be concatenated within one pair of brackets.
% Vertical and horizontal concatenation may be combined together as for
...
R = mdf(vertcat(num{1:ni}),vertcat(den{1:ni}));
