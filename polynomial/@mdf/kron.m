...
%KRON   Kronecker tensor product of matrix-den fractions
%
...
eval('A = mdf(A);','error(''Invalid 1st argument.'');');
...
den = kron(A.frac.den,B.frac.den,tol);
C = mdf(num,den);
