function [N,D] = zpk2rmf(Z,P,K,var,tol)
%ZPK2RMF  Convert from zero-pole-gain format to a right matrix fraction
%
...
% the function
%     [N,D] = ZPK2RMF(Z,P,K)
% returns a right coprime matrix fraction description of H = N*D^{-1}.
%
