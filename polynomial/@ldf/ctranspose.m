...
%CTRANSPOSE   Conjugated transpose of left-den fraction
%
% The command  FT = F'  or  FT = CTRANSPOSE(F)
% returns the conjugated transpose of the left-den fraction F.
% The result is right-den fraction.
%
...
%
% See also LDF/TRANSPOSE, FRAC/CONJ, POL/CTRANSPOSE.
