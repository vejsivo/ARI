...
%DIAG  Diagonal matrix or diagonal of left-den fraction
%
% Let Av be a left-den vector fraction with N components. Then
%    DIAG(Av,K)  
% is a square left-den fraction of dimensions
...
% 
% Let Am be a left-den matrix fraction. Then
%    DIAG(Am,K)
% is a column vector left-den fraction formed from the elements of
