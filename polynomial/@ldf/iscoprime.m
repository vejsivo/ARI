...
%ISCOPRIME   Test if left-den fraction is coprime
%
% The expression  ISCOPRIME(F)  returns 1 if the left-den
% fraction F is left coprime, otherwise 0.
%
...
stol = num2str(tol);
G = gld(F.frac.num,F.frac.den,stol);
degG = deg(G);
