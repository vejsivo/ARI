...
%ABCDE   Descriptor state space realization of a left-den fraction
%
% For left-denominator fraction F, the command
%    [A,B,C,D,E] = ABCDE(F)
...
eval('[A,B,C,D,E] = lmf2dss(F.frac.num,F.frac.den,tol);', ...
   'error(peel(lasterr));');
