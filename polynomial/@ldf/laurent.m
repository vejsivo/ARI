...
%LAURENT      Laurent series of left-den fraction
%
% If F is a left-den fraction in variables 'z' or 'q' then
...
%
% If F is a left-den fraction in variables 'z^-1' or 'd' then
% the command   Q = LAURENT(F,DEGREE)
% returns (possibly two-sided) polynomial Q ... the first
% terms of the Laurent series of F about the point z^-1=d=0
% (from positive powers of 'z' down to the power  z^-DEGREE ).
%
% If F is a left-den fraction in variables 's' or 'p' then
