...
%SYM  Convert a left-den matrix fraction to symbolic format.
%
% The commands
%    AS = SYM(AF)
%    AS = SYM(AF,VAR)
% convert a left-den matrix fraction AF of the Polynomial Toolbox
...
% $ Revision $  $ Date 02-Nov-2000  J.Jezek $
...
eval('Asym = densym \ numsym;','error(peel(lasterr));');
